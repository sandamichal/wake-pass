    ...
    import OwnerDashboard from './pages/OwnerDashboard'; // Nový import
    ...
    function App() {
      ...
      const renderContent = () => {
        ...
        let dashboard;
        // Zde rozhodujeme, který panel zobrazit
        switch (activeRole) {
          case 'owner':
            dashboard = <OwnerDashboard />;
            break;
          case 'operator':
            dashboard = <OperatorDashboard user={session.user} />;
            break;
          default:
            dashboard = <CustomerDashboard user={session.user} />;
        }
