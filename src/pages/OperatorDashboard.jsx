...
import { QRCodeSVG } from 'qrcode.react'; // Importujeme QR kód komponentu

const CustomerDashboard = ({ user }) => {
  const [balance, setBalance] = useState(null);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(null);
  const [qrToken, setQrToken] = useState(null); // Stav pro uložení QR tokenu
  ...
  // Pokud máme QR token, zobrazíme speciální obrazovku
  if (qrToken) {
    return (
